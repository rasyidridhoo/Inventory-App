...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-3 mb-3">Tambah Data Barang</h1>
            <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{route('barang.store')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="text" id="KODEBRG" name="KODEBRG" autocomplete="off" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="text" id="NAMABRG" name="NAMABRG" autocomplete="off" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="text" id="SATUAN" name="SATUAN" autocomplete="off" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="number" id="HARGABELI" name="HARGABELI" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="form-group row mt-3">
                                @if ($errors->any())
