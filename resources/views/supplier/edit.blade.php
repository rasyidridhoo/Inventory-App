...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-3 mb-3">Edit Data Supplier</h1>
            <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="/supplier/{{$supplier->id}}/update">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="text" id="KODESPL" name="KODESPL" autocomplete="off" value="{{$supplier->KODESPL}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="text" id="NAMASPL" name="NAMASPL" autocomplete="off" value="{{$supplier->NAMASPL}}" required>
                                </div>
                            </div>
