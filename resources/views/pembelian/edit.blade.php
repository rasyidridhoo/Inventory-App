...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-3 mb-3">Edit Data Pembelian</h1>
            <div class="card mb-4">
                <div class="card-header">
                
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="/pembelian/{{$pembelian->NOTRANSAKSI}}/update">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" name="KODESPL" id="KODESPL" required>
                                        ...
                                        @foreach($supplierlist as $item)
                                            <option value="{{$item->KODESPL}}" @if ($item->KODESPL == $pembelian->hbeli->KODESPL) selected @endif>{{$item->NAMASPL}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" name="KODEBRG" id="KODEBRG" required>
                                        ...
                                        @foreach($baranglist as $item)
                                            <option value="{{$item->KODEBRG}}" data-hargabeli="{{$item->HARGABELI}}" @if ($item->KODEBRG == $pembelian->KODEBRG) selected @endif>{{$item->NAMABRG}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="HARGABELI" value="{{$pembelian->HARGABELI}}" id="HARGABELI" required readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-md-9">
                                    <input type="date" class="form-control" name="TGLBELI" id="TGLBELI" value="{{ \Carbon\Carbon::parse($pembelian->TGLBELI)->format('Y-m-d') }}" required >
                                </div>
                            </div>
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="number" id="QTY" name="QTY" value="{{$pembelian->QTY}}" autocomplete="off" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="number" id="DISKON" name="DISKON" value="{{$pembelian->DISKON}}" autocomplete="off" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="number" id="DISKONRP" value="{{$pembelian->DISKONRP}}" name="DISKONRP" autocomplete="off" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="number" id="TOTALRP" name="TOTALRP" value="{{$pembelian->TOTALRP}}" autocomplete="off" required>
                                </div>
                            </div>
